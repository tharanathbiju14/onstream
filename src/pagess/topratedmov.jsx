...
const Popular = () => {
  const { data, loading, error, page, setPage } = usePaginatedFetchTMDB('/movie/top_rated');
  ...
  return (
    <div>
      <SidebarDrawer/>
      <p style={{ fontSize: '30px', padding: '30px', color: 'white',marginLeft:"60px",marginTop:"18px" }}>Top Rated</p>
